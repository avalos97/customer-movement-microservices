package com.devsu.res.movement_service.common.constant;
...
public enum ErrorCode {
    ...
    BALANCE_NOT_AVAILABLE("PACKT-0009", "Insufficient balance to complete the transaction."),
    MOVEMENT_NOT_FOUND("PACKT-0010", "Movement not found - ");
